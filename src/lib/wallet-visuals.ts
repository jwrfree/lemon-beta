...
const brandGradients: Record<string, { gradient: Gradient; textColor: string; logo?: string }> = {
    ...
    'seabank': { gradient: { from: '#FF5400', to: '#A83700' }, textColor: 'text-white', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c8/SeaBank_logo.svg/512px-SeaBank_logo.svg.png' },
    'sea bank': { gradient: { from: '#FF5400', to: '#A83700' }, textColor: 'text-white', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c8/SeaBank_logo.svg/512px-SeaBank_logo.svg.png' },
    'superbank': { gradient: { from: '#CCFF00', to: '#8AB300' }, textColor: 'text-black', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c2/Superbank_Logo.svg/512px-Superbank_Logo.svg.png' },
