...
export const MERCHANT_MAP: Record<string, MerchantVisuals> = {
    ...
    'oli motor': { icon: Wrench, color: 'text-orange-600', bgColor: 'bg-orange-50' },
    'oli mobil': { icon: Wrench, color: 'text-orange-600', bgColor: 'bg-orange-50' },
    'ganti oli': { icon: Wrench, color: 'text-orange-600', bgColor: 'bg-orange-50' },
    'yamalube': { icon: Wrench, color: 'text-rose-600', bgColor: 'bg-rose-50', domain: 'yamaha-motor.co.id' },
    'shell advance': { icon: Wrench, color: 'text-yellow-500', bgColor: 'bg-rose-50', domain: 'shell.co.id' },
    'federal oil': { icon: Wrench, color: 'text-rose-700', bgColor: 'bg-rose-50', domain: 'federaloil.co.id' },
    'motul': { icon: Wrench, color: 'text-rose-600', bgColor: 'bg-zinc-900', domain: 'motul.com' },
    'castrol': { icon: Wrench, color: 'text-emerald-700', bgColor: 'bg-emerald-50', domain: 'castrol.com' },
    'ahass': { icon: Wrench, color: 'text-rose-600', bgColor: 'bg-rose-50', domain: 'astra-honda.com' },
