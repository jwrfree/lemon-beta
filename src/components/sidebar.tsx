            ...
            <div className={cn('flex items-center mb-12 transition-all duration-300 w-full', isSidebarCollapsed ? 'justify-center' : 'px-3')}>
                ...
                {!isSidebarCollapsed && (
                    <div className="flex flex-col ml-4 overflow-hidden whitespace-nowrap">
                        ...
                        <p className="text-label truncate opacity-50 mt-1.5">{SIDEBAR_CONFIG.appVersion}</p>
                    </div>
                )}
            </div>
                    ...
                    {SIDEBAR_NAV_ITEMS.map((item) => {
                        ...
                        return (
                            <Tooltip key={item.id}>
                                ...
                                {isSidebarCollapsed && (
                                    <TooltipContent side="right" sideOffset={20} className="text-label bg-card text-foreground border-border shadow-xl">
                                        {item.name}
                                    </TooltipContent>
                                )}
                            </Tooltip>
                        ...
                        <Tooltip>
                            <TooltipTrigger asChild>
                                <Button
                                    ...
                                    className={cn(
                                        'text-primary hover:bg-primary/10 rounded-full transition-all duration-300 text-label',
                            ...
                            {isSidebarCollapsed && (
                                <TooltipContent side="right" sideOffset={20} className="text-label bg-card text-primary border-primary/20 shadow-xl">
                                    Install App
                                </TooltipContent>
                            )}
                        </Tooltip>
                    ...
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <Button
                                ...
                                className={cn(
                                    'text-muted-foreground hover:bg-muted/50 hover:text-foreground rounded-full transition-all duration-300 text-label',
                                    isSidebarCollapsed ? 'w-12 h-12 p-0 mx-auto flex items-center justify-center' : 'w-full justify-start gap-4 px-4 h-11'
                                )}
                            >
                    ...
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <Button
                                ...
                                className={cn(
                                    'text-muted-foreground hover:bg-muted/50 rounded-full transition-all duration-300 text-label',
                                    isSidebarCollapsed ? 'w-12 h-12 p-0 mx-auto flex items-center justify-center' : 'w-full justify-start gap-4 px-4 h-11'
                                )}
                            >
                        ...
                        <Tooltip>
                            <TooltipTrigger asChild>
                                <Button
                                    ...
                                    className={cn(
                                        'text-muted-foreground hover:text-destructive hover:bg-destructive/10 rounded-full transition-all duration-300 text-label',
                            ...
                            {isSidebarCollapsed && (
                                <TooltipContent side="right" sideOffset={20} className="text-label bg-destructive text-destructive-foreground border-none shadow-xl">
                                    Keluar Akun
                                </TooltipContent>
                            )}
                        </Tooltip>
