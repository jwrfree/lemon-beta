...
export const Sidebar = () => {
 ...
 <span className="text-title-lg leading-none">L</span>
 </div>
 {!isSidebarCollapsed && (
 <div className="min-w-0">
 <p className="truncate text-body-lg tracking-tight text-foreground">
 ...
 {!isSidebarCollapsed && (
 <p className="px-2 text-label-sm text-muted-foreground/80">
 Aksi cepat
 </p>
 )}
 ...
 {!isSidebarCollapsed && <span className="text-body-md ">Smart Add</span>}
 </Button>
 </SidebarAction>
 ...
 {!isSidebarCollapsed && <span className="text-body-md ">Tanya Lemon AI</span>}
 </Button>
 </SidebarAction>
 </div>
 ...
 {!isSidebarCollapsed && (
 <p className="px-3 text-label-sm text-muted-foreground/80">
 {section.label}
 </p>
 )}
 ...
 prefetch={false}
 className={cn(
 'group relative flex items-center text-body-md transition-all duration-200',
 isSidebarCollapsed
 ...
 >
 {!isSidebarCollapsed && (
 <p className="px-2 pb-2 text-label-sm text-muted-foreground/80">
 Lainnya
 </p>
 )}
 ...
 {!isSidebarCollapsed && <span className="text-body-md font-medium">Install App</span>}
 </Button>
 </SidebarAction>
 </div>
 )}
