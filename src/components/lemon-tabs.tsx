...
export const LemonTabs = ({
 ...
 key={tab.value}
 value={tab.value}
 className="h-full rounded-lg font-medium text-label-md transition-all data-[state=active]:bg-background data-[state=active]:text-foreground flex items-center gap-2"
 >
