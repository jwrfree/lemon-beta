...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-background p-6 shadow-[0_28px_70px_-36px_rgba(15,23,42,0.38)] motion-panel data-[state=closed]:duration-[var(--motion-duration-fast)] data-[state=open]:duration-[var(--motion-duration-normal)] data-[state=open]:ease-[var(--motion-easing-standard)] data-[state=closed]:ease-in",
  {
    variants: {
      side: {
