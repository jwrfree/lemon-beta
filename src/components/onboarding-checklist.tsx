...
export const OnboardingChecklist = () => {
 ...
 <span className="text-label-sm ">{Math.round(progress)}%</span>
 </div>
 <div>
 <h3 className="flex items-center gap-2 text-body-md text-foreground">
 ...
 >
 <Button 
 className="mt-2 h-10 w-full border-none bg-primary text-black shadow-sm hover:bg-primary/90"
