...
export function InstallPrompt() {
 ...
 <span className="text-body-md">Install Lemon App</span>
 <span className="text-label-md text-muted-foreground">Akses lebih cepat & offline</span>
 </div>
 </div>
 ...
 size="sm"
 className="h-8 text-label-md font-medium px-3"
 >
 Install
 </Button>
        <Button
