...
export const EmptyState = ({
 ...
 <h2 className="text-display-sm md:text-display-md mb-3 md:mb-4 max-w-[280px] md:max-w-[360px]">
 {title}
 </h2>

 {/* Description - action-oriented with improved max-width */}
 <p className={cn(
 "text-label-md md:text-body-md font-medium text-muted-foreground leading-relaxed mb-8 md:mb-10",
 ...
 "text-label-md md:text-body-md border-none shadow-none",
 // Active state
