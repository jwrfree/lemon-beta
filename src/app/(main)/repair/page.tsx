...
export default function RepairPage() {
 ...
 <CardTitle className="text-display-md font-medium text-foreground">Database Repair Tool</CardTitle>
 <CardDescription>
 ...
 <h3 className="text-display-sm font-medium text-success mb-1">Perbaikan Selesai!</h3>
 <p className="text-muted-foreground mb-6 font-medium">
 Berhasil memperbaiki <span className="text-display-md font-medium text-success">{result.fixed}</span> item.
 </p>
 ...
 disabled={isLoading}
 size="lg"
 className="w-full h-14 text-title-lg font-medium shadow-xl shadow-primary/20 transition-all hover:scale-[1.02] active:scale-[0.98]"
 >
 {isLoading ? (
