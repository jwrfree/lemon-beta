        ...
        <header className="flex items-center justify-between px-4 pt-4 md:px-6">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex h-11 w-11 items-center justify-center rounded-full bg-card text-muted-foreground shadow-sm border border-border/15 active:scale-95 transition-all"
            >
              <Compass size={16} />
            </button>
          </div>
