    ...
    <div className="bg-muted min-h-screen animate-pulse p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="md:col-span-2 space-y-6">
                 <div className="h-48 bg-muted-foreground/20 rounded-xl"></div>
                 <div className="grid grid-cols-2 gap-4">
                    <div className="h-32 bg-muted-foreground/20 rounded-xl"></div>
                    <div className="h-32 bg-muted-foreground/20 rounded-xl"></div>
                 </div>
            </div>
            <div className="space-y-6">
                <div className="h-64 bg-muted-foreground/20 rounded-xl"></div>
                <div className="h-64 bg-muted-foreground/20 rounded-xl"></div>
            </div>
        </div>
    </div>
    ...
    return (
        <>
            ...
            <div className="md:hidden bg-muted min-h-full flex flex-col">
                <header className="h-16 px-4 flex items-center justify-between sticky top-0 bg-background z-20 border-b shrink-0">
