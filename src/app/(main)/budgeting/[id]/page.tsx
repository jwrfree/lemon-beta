...
export default function BudgetDetailPage() {
 ...
 <h2 className="text-display-sm">Tidak Ditemukan</h2>
 ...
 <h2 className="text-display-md tabular-nums text-foreground">
 ...
 className="w-full h-14 rounded-full bg-primary text-primary-foreground font-medium text-body-lg shadow-sm hover:opacity-90 active:scale-[0.98] transition-all"
 >
 Tambah transaksi
 </Button>
 </motion.div>
 ...
 <h3 className="text-title-lg tracking-tight text-foreground">Status</h3>
 ...
 <Card className="border-none rounded-card-premium bg-card shadow-sm p-7 overflow-hidden active:bg-muted/30 transition-colors">
 ...
 <span className="text-display-sm font-medium tracking-tight text-foreground">{progress.toFixed(1)}%</span>
 </div>
 ...
 <span className={cn("text-display-sm font-medium tracking-tight", isOver ? "text-destructive": "text-foreground")}>
 ...
 onClick={() => { triggerHaptic('light'); openEditBudgetModal(budget); }}
 >
 <Card className="border-none rounded-card-premium bg-card shadow-sm p-7 space-y-7 cursor-pointer active:bg-muted/30 transition-colors">
 ...
 <span className="text-body-lg font-medium tracking-tight text-foreground">{budget.name}</span>
 </div>
 </div>
 ...
 <span className="text-body-lg font-medium tracking-tight text-foreground truncate max-w-[200px]">
 ...
 <span className="text-body-lg font-medium tracking-tight tabular-nums text-foreground">{formatCurrency(budget.targetAmount)}</span>
 </div>
 </div>
 </Card>
 </motion.div>
 ...
 <div className="rounded-card-premium bg-card shadow-sm overflow-hidden min-h-[100px]">
 <TransactionList
