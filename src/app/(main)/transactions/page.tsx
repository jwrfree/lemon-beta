...
function TransactionsPageContent() {
 ...
 className="pl-10 h-10 text-body-md bg-muted/50 border-none focus-visible:ring-4 focus-visible:ring-primary/5 rounded-card transition-all"
 value={searchQuery}
 ...
 <button onClick={() => setSelectedCategories([])} className="text-label-md text-destructive ">Bersihkan</button>
 )}
 </div>
 ...
 <button onClick={() => setSelectedWallets([])} className="text-label-md text-destructive ">Bersihkan</button>
 )}
 </div>
 <div className="flex flex-wrap gap-2">
