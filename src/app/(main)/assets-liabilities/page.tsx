...
export default function AssetsLiabilitiesPage() {
    ...
    const totals = useMemo(() => {
        ...
        const chartData = [
            { name: 'Aset Produktif', value: realAssetsValue, color: '#0d9488' }, // teal-600
            { name: 'Aset Konsumtif', value: depreciatingAssetsValue, color: '#e11d48' }, // rose-600
            { name: 'Liabilitas', value: totalLiabilities, color: '#4f46e5' }, // indigo-600
