...
export const DeepSeekUsageCard = () => {
    ...
    return (
        <Card className="border-none shadow-card bg-gradient-to-br from-indigo-950 via-slate-900 to-black text-white overflow-hidden relative group rounded-card">
