                ...
                <div className="bg-muted/30 rounded-[24px] overflow-hidden border border-border/20 shadow-inner">
                            ...
                            <Popover open={isSubCatOpen} onOpenChange={setIsSubCatOpen}>
                                <PopoverTrigger asChild>
                                    <div className="flex items-center justify-between p-5 cursor-pointer hover:bg-muted/50 transition-colors active:scale-[0.99]">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div className="flex flex-col items-start space-y-0.5">
                                                <span className="text-sm font-bold tracking-tight">{parsedData.subCategory || 'Pilih Sub-kategori'}</span>
                                                <span className="text-[10px] text-muted-foreground/60 font-bold uppercase tracking-widest">Sub-kategori</span>
                                            </div>
                                        </div>
                                        <div className="flex items-center gap-2 text-muted-foreground/40">
                                            <span className="text-[10px] font-bold uppercase tracking-widest">Adjust</span>
                                ...
                                <PopoverContent className="w-72 p-0 rounded-[28px] shadow-2xl border-none overflow-hidden" align="center">
                                    <div className="p-4 bg-popover/95 backdrop-blur-xl">
                                        <p className="text-[10px] font-black text-muted-foreground/40 mb-3 px-1 uppercase tracking-[0.3em]">Pilih Sub-kategori</p>
                    ...
                    <Popover open={isWalletOpen} onOpenChange={setIsWalletOpen}>
                        <PopoverTrigger asChild>
                            <div className="flex items-center justify-between p-5 cursor-pointer hover:bg-muted/50 transition-colors active:scale-[0.99]">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="flex flex-col items-start space-y-0.5">
                                        <span className="text-sm font-bold tracking-tight">{selectedWallet?.name || 'Pilih Dompet'}</span>
                                        <span className="text-[10px] text-muted-foreground/60 font-bold uppercase tracking-widest">Sumber Dana</span>
                                    </div>
                                </div>
                                <div className="flex items-center gap-2 text-muted-foreground/40">
                                    <span className="text-[10px] font-bold uppercase tracking-widest">Adjust</span>
                        ...
                        <PopoverContent className="w-64 p-0 rounded-[28px] shadow-2xl border-none overflow-hidden" align="center">
                            <div className="p-4 bg-popover/95 backdrop-blur-xl">
                                <p className="text-[10px] font-black text-muted-foreground/40 mb-3 px-1 uppercase tracking-[0.3em]">Pilih Sumber Dana</p>
                    ...
                    <Popover open={isDateOpen} onOpenChange={setIsDateOpen}>
                            ...
                            <div className="flex items-center justify-between p-5 cursor-pointer hover:bg-muted/50 transition-colors active:scale-[0.99]">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="flex flex-col items-start space-y-0.5">
                                        ...
                                        <span className="text-[10px] text-muted-foreground/60 font-bold uppercase tracking-widest">Waktu Transaksi</span>
                                    </div>
                                </div>
                                <div className="flex items-center gap-2 text-muted-foreground/40">
                                    <span className="text-[10px] font-bold uppercase tracking-widest">Adjust</span>
                        ...
                        <PopoverContent className="w-auto p-0 rounded-[28px] shadow-2xl border-none overflow-hidden" align="center">
                            <div className="p-4 bg-popover/95 backdrop-blur-xl space-y-3">
                                <p className="text-[10px] font-black text-muted-foreground/40 mb-1 px-1 uppercase tracking-[0.3em]">Waktu Transaksi</p>
                                <Calendar
                                    mode="single"
                                    selected={parsedDate}
