                ...
                >
                    <div className="mx-auto w-full max-w-sm space-y-3.5">
                        <motion.div
                            ...
                            className="rounded-[28px] bg-card p-5 shadow-[0_18px_36px_-30px_rgba(15,23,42,0.14)]"
                        >
                        ...
                        <motion.div
                            ...
                            className="rounded-[24px] bg-muted/35 p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.16)] dark:bg-card/80"
                        >
                            <div className="flex items-center gap-4 overflow-hidden">
                                ...
                                <div className={cn('shrink-0 text-right text-sm font-semibold tracking-tight tabular-nums', amountColor)}>
                ...
                <div className="shrink-0 bg-background/96 px-4 pb-[calc(1rem+env(safe-area-inset-bottom))] pt-3 shadow-[0_-18px_30px_-28px_rgba(15,23,42,0.2)] backdrop-blur-sm sm:px-8">
                    <div className="mx-auto flex w-full max-w-sm flex-col gap-3">
                        <Button
                            ...
                            disabled={isDeleting}
                            variant="destructive"
                            className="h-12 w-full rounded-full text-sm font-semibold transition-all active:scale-[0.98]"
                        >
                        ...
                        <Button
                            ...
                            disabled={isDeleting}
                            variant="ghost"
                            className="h-12 w-full rounded-full bg-background text-sm font-semibold text-muted-foreground transition-colors hover:text-foreground"
                        >
                            Batal
                        </Button>
                    </div>
