            ...
            >
                ...
                >
                    <div className="mx-auto w-full max-w-sm space-y-3.5">
                        <motion.div
                            ...
                            className="rounded-3xl bg-card px-5 py-5 shadow-elevation-3"
                        >
                        ...
                        <motion.div
                            ...
                            className="rounded-3xl bg-card px-4 py-2 shadow-elevation-2"
                        >
                        ...
                        <motion.div
                            ...
                            className="overflow-hidden rounded-3xl bg-card px-1 shadow-elevation-2"
                        >
                ...
                <div className="shrink-0 bg-background/96 px-4 pb-[calc(1rem+env(safe-area-inset-bottom))] pt-3 shadow-elevation-3 backdrop-blur-sm sm:px-8">
                    <div className="mx-auto w-full max-w-sm">
                        <Button
                            onClick={onClose}
                            className="h-12 w-full rounded-full bg-primary text-sm font-semibold text-primary-foreground transition-all active:scale-[0.98] hover:opacity-90"
                        >
                            OK
                        </Button>
                    </div>
