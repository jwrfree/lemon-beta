        ...
        <div className="grid grid-cols-3 gap-2 rounded-full bg-muted p-1">
            <Button
                ...
                className={cn(
                    ...
                    type === 'expense' ? 'bg-destructive text-destructive-foreground shadow-sm' : 'bg-transparent text-muted-foreground hover:bg-background/50'
                )}
            >
                Pengeluaran
            </Button>
            <Button
                ...
                className={cn(
                    "rounded-full transition-all duration-200",
                    type === 'income' ? 'bg-green-600 text-white shadow-sm' : 'bg-transparent text-muted-foreground hover:bg-background/50'
                )}
            >
                Pemasukan
            </Button>
