...
export const HeroAmount = ({ amount, type, onAmountClick, compact = false }: HeroAmountProps) => {
 ...
 compact ? "text-title-lg": "text-display-md",
 typeColors[type]
 )}>
 {symbol}
 </span>
 ...
 compact ? "text-display-lg md:text-display-lg": "text-6xl md:text-8xl",
 typeColors[type]
 )}>
 {valueStr}
 </span>
 ...
 {!compact && (
 <p className="mt-4 text-label-md text-label text-muted-foreground/40 group-hover:text-primary transition-colors">
