    ...
    return (
        ...
        >
            <motion.div
                ...
                className="w-full max-w-lg bg-background/95 backdrop-blur-xl rounded-t-card-premium md:rounded-card-premium shadow-card flex flex-col h-auto max-h-[92vh] md:max-h-[85vh] border border-border/10 overflow-hidden relative pb-6"
            ...
            >
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="overflow-y-auto p-6 space-y-8">
                    ...
                    <div className="space-y-3">
                        ...
                        <Input {...form.register('description')} id="description" placeholder="makan siang, bensin, dll..." className={cn("h-12 rounded-2xl bg-secondary/50 border-border/50 shadow-inner shrink-0 focus-visible:border-primary/50 focus-visible:ring-primary/20", errors.description && "bg-destructive/5")} />
