            ...
            >
                <div className="flex flex-col gap-3 bg-muted px-4 pb-4 pt-3">
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            <h2 className="text-xl font-semibold tracking-tight text-foreground">Pilih kategori</h2>
                    ...
                    <div className="space-y-5 px-4 pb-[calc(1rem+env(safe-area-inset-bottom))] pt-2">
                        {selectedCategory && !normalizedQuery ? (
                            <div className="space-y-2">
                                <p className="px-1 text-label font-semibold uppercase tracking-widest text-muted-foreground/55">
                                    Terpilih
                                </p>
                                <CategoryRow
