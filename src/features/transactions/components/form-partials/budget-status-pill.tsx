...
export const BudgetStatusPill = ({ category }: BudgetStatusPillProps) => {
 ...
 >
 <div className={cn(
 "flex items-center justify-between rounded-md px-4 py-3 text-label-md shadow-elevation-2 transition-colors duration-500",
 isOverBudget
 ...
 <span className="tabular-nums text-body-md font-medium">
 ...
 className="flex items-center gap-2 px-1 text-label-md text-amber-600"
 >
