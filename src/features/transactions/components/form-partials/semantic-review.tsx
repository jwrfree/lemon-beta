...
export const SemanticTransactionReview = ({
 ...
 className="flex w-full items-center gap-3 rounded-xl bg-card px-4 py-3 text-left transition-all active:scale-[0.98] shadow-sm"
 >
 ...
 <span className="text-body-md font-medium text-yellow-900 dark:text-yellow-100">Pilih kategori</span>
 )}
 </div>
 <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-background text-muted-foreground">
 ...
 walletObj ? "bg-card text-foreground shadow-sm": missingFieldClass
 )}
 >
