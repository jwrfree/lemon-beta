...
export function AmountInput<T extends FieldValues>({
 ...
 <span className="inline-flex items-center gap-1.5 rounded-lg bg-muted/50 px-2 py-0.5 text-label text-muted-foreground/60 shadow-sm">
 {label}
 </span>
 </div>
 )}
 ...
 className={cn(
 'h-14 rounded-card bg-muted/22 pr-20 text-display-md font-medium shadow-elevation-2 focus-visible:ring-primary/20',
 showCurrencyPrefix && 'pl-14',
 error && 'border-destructive focus-visible:border-destructive focus-visible:ring-destructive/20'
 )}
 />
 {showCurrencyPrefix && (
 <span className="pointer-events-none absolute left-4 top-1/2 -translate-y-1/2 text-body-lg text-muted-foreground">
 Rp
 </span>
 )}
 ...
 className="whitespace-nowrap rounded-full bg-muted/55 px-3 py-1.5 text-label-md font-medium transition-colors hover:bg-primary/10 hover:text-primary active:scale-95"
 >
 ...
 className={cn(
 'h-10 rounded-lg text-body-md font-medium shadow-elevation-2 transition-colors',
 ['+', '-', '*', '/'].includes(key)
 ...
 className="h-9 w-full rounded-lg bg-muted/55 text-label-md text-muted-foreground transition-colors hover:bg-muted/70"
 >
 Selesai
 </button>
 </div>
