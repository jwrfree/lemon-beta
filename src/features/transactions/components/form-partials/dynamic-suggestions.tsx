...
const RepeatSuggestionCard = ({
 ...
 <p className="truncate text-body-md tracking-tight text-foreground">{suggestion.label}</p>
 <span className="shrink-0 rounded-full bg-primary/10 px-2 py-0.5 text-label text-primary">
 {suggestion.reason}
 </span>
 </div>
 <p className="truncate pt-0.5 text-label-md font-medium text-muted-foreground/75">{suggestion.description}</p>
 </div>
 <div className="flex shrink-0 items-center gap-1 text-primary">
 <span className="text-label ">{suggestion.amount ? formatCompactAmount(suggestion.amount) : ''}</span>
...
const HabitSuggestionChip = ({
 ...
 <span className="truncate text-body-md tracking-tight text-foreground">{suggestion.label}</span>
...
const ActionSuggestionCard = ({
 ...
 <span className="line-clamp-2 block text-body-md tracking-tight">{suggestion.label}</span>
...
export const DynamicSuggestions = ({ onSuggestionClick, suggestions }: DynamicSuggestionsProps) => {
 ...
 <p className="text-body-md leading-relaxed text-muted-foreground/75">
