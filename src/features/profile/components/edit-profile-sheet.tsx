...
export const EditProfileSheet = ({ isOpen, onClose }: EditProfileSheetProps) => {
 ...
 <SheetContent
 side="bottom"
 className="rounded-t-[32px] bg-background p-0 sm:max-w-lg mx-auto border-none shadow-elevation-4 overflow-hidden"
 >
 ...
 <SheetTitle className="text-display-md tracking-tighter">Edit Profil</SheetTitle>
 <SheetDescription className="text-label text-muted-foreground/40">Sesuaikan identitas digital kamu</SheetDescription>
 </SheetHeader>
 ...
 />
 <div className="absolute bottom-0 right-0 h-9 w-9 rounded-full bg-foreground text-background flex items-center justify-center border-4 border-background">
 ...
 <p className="text-label text-muted-foreground/30">Ketuk untuk ubah foto</p>
 </div>

 {/* FORM FIELDS */}
 <div className="space-y-6">
 <div className="space-y-2">
 <Label htmlFor="displayName"className="text-label text-muted-foreground/60 ml-1">Nama Tampilan</Label>
 <Input
 id="displayName"
 {...form.register('displayName')}
 placeholder="Masukkan nama kamu"
 className="h-14 rounded-2xl bg-muted/40 border-none px-5 text-body-lg tracking-tight focus:ring-accent"
 />
 {form.formState.errors.displayName && (
 <p className="text-label text-destructive ml-1 ">{form.formState.errors.displayName.message}</p>
 )}
 </div>
 ...
 className="h-14 w-full rounded-2xl bg-foreground text-background text-body-lg tracking-tight hover:bg-foreground/90 transition-all active:scale-95"
 >
 ...
 variant="ghost"
 onClick={onClose}
 className="h-12 w-full rounded-xl text-muted-foreground text-label-md "
 >
 Batalkan
 </Button>
 </SheetFooter>
