...
export const AiBriefingCard = () => {
    ...
    if (isLoading) {
        return (
            <div className="px-4">
                <Skeleton className="w-full h-[120px] rounded-card-premium bg-card/50" />
            </div>
        );
    }
    ...
    return (
        ...
        >
            <div className={cn(
                "relative overflow-hidden rounded-card-premium p-5 border backdrop-blur-xl transition-all duration-500",
                mood.bg
            )}>
                {/* Ambient Glow */}
                ...
                <div className="flex gap-4 relative z-10">
                    <div className={cn("shrink-0 h-10 w-10 rounded-xl flex items-center justify-center border border-white/10 bg-white/5", mood.iconColor)}>
                    ...
                    <div className="space-y-3 flex-1">
                        ...
                        {briefing.suggestion && (
                            ...
                            >
                                <div className="h-6 w-6 rounded-full bg-primary/10 flex items-center justify-center border border-primary/20 group-hover:bg-primary/20 transition-colors">
