                ...
                <div className="grid grid-cols-2 gap-3">
                    <Card className="shadow-sm border-border/60 bg-gradient-to-br from-card to-destructive/5 overflow-hidden">
                        <CardContent className="p-4">
                            ...
                            <p className="text-lg font-bold text-destructive">{formatCurrency(totals.totalOwed)}</p>
                        </CardContent>
                    </Card>
                    <Card className="shadow-sm border-border/60 bg-gradient-to-br from-card to-emerald-500/5 overflow-hidden">
                        <CardContent className="p-4">
                            ...
                            <p className="text-lg font-bold text-emerald-600">{formatCurrency(totals.totalOwing)}</p>
                        </CardContent>
                    </Card>
                </div>
            </div>
            ...
            <Tabs value={activeFilter} onValueChange={setActiveFilter} className="w-full">
                <TabsList className="bg-muted p-1 rounded-2xl h-12 w-full grid grid-cols-4">
                    {Object.entries(filterLabels).map(([value, label]) => (
                        <TabsTrigger key={value} value={value} className="h-full rounded-xl font-bold text-[10px] uppercase tracking-wider transition-all data-[state=active]:bg-white data-[state=active]:text-slate-950 data-[state=active]:shadow-sm px-1">
