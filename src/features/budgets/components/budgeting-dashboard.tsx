...
export const BudgetingDashboard = () => {
 ...
 <h2 className="text-label-md text-muted-foreground/60 px-2">Ringkasan bulan ini</h2>
 ...
 <p className="text-display-md tracking-tighter tabular-nums text-primary">{Math.round((overview.totalRemaining / overview.totalBudget) * 100)}%</p>
 </div>
 ...
 <p className="text-display-md tracking-tighter tabular-nums">{formatCurrency(overview.totalBudget)}</p>
 </div>
 </div>
 </CardContent>
 </Card>
 ...
 <h2 className="text-label-md text-muted-foreground/60">Pos anggaran</h2>
 <Button onClick={() => setIsBudgetModalOpen(true)} variant="ghost"size="sm"className="h-8 rounded-full text-label-sm text-primary hover:bg-transparent">
