...
export const LoginPage = ({
 ...
 <span className="absolute inset-x-0 -top-2 mx-auto w-max bg-background px-3 text-label-md text-muted-foreground">atau lanjutkan</span>
 </div>
 
 <Button
 variant="outline"
 size="lg"
 className="w-full text-body-lg h-12"
