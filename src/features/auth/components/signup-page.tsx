...
export const SignUpPage = ({
 ...
 <p className="text-body-md text-muted-foreground mb-4">Mulai kelola keuanganmu bersama Lemon. Buat akun gratis dan dapatkan insight personal.</p>
 <Form {...form}>
 ...
 <p className="text-label-md text-muted-foreground">{passwordStrength.label}</p>
 </div>
 )}
 <FormMessage />
 </FormItem>
 ...
 <span className="absolute inset-x-0 -top-2 mx-auto w-max bg-background px-3 text-label-md text-muted-foreground">atau</span>
 </div>
 <Button
 variant="outline"
 size="lg"
