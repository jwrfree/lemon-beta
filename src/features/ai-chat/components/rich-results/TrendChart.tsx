...
export const TrendChart = ({ data }: TrendChartProps) => {
 ...
 <div className="text-body-md text-foreground">Trend pengeluaran</div>
 ...
 <div className="inline-flex items-center gap-1 rounded-full bg-muted px-2.5 py-1 text-label-md text-muted-foreground">
 ...
 <div className="text-foreground">{monthLabel(point.month)}</div>
