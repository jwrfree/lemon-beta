...
`${negativeMonths} bulan defisit`,
 ...
 if (items.length === 0) {
 return <p className="text-label-md text-muted-foreground">{emptyLabel}</p>;
 }
 ...
 <p className="text-body-md font-medium text-foreground">{item.category}</p>
 <p className="text-label-md font-medium text-muted-foreground/60">{item.percentage.toFixed(1)}%</p>
 </div>
 <span className="text-body-md font-medium text-foreground tabular-nums">{formatCurrency(item.value)}</span>
 </div>
 <Progress 
 ...
 className={cn(
 'rounded-full border border-transparent px-3 py-1.5 text-label-md font-medium transition',
 ...
 <div className="flex flex-wrap items-center justify-end gap-3 text-label-md font-medium text-muted-foreground/60 px-1">
 ...
 <p className="text-label-md font-medium text-label text-primary/70">Total Net</p>
 <p className={cn('text-display-lg font-medium tracking-tight', filteredTotals.net >= 0 ? 'text-teal-600': 'text-destructive')}>
 ...
 <p className="text-label-md font-medium text-label text-primary/70">Fokus Bulan</p>
 <p className="text-display-sm font-medium text-foreground tracking-tight">{selectedMonthData.fullLabel}</p>
 </div>
 <Badge
 className={cn(
 'rounded-full px-3 py-1 text-label-md font-medium border-none',
 ...
 <p className="text-label-md font-medium text-label text-teal-600/70">Pemasukan</p>
 <span className="text-body-md font-medium text-foreground">{formatCurrency(selectedMonthData.income)}</span>
 </div>
 {renderBreakdown(selectedMonthData.incomeBreakdown, 'Kosong', 'bg-teal-600')}
 </div>
 <div className="space-y-3">
 <div className="flex items-center justify-between px-1">
 <p className="text-label-md font-medium text-label text-destructive/70">Pengeluaran</p>
 <span className="text-body-md font-medium text-foreground">{formatCurrency(selectedMonthData.expense)}</span>
 </div>
