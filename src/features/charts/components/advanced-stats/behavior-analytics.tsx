...
export function BehaviorAnalytics({ data }: { data: BehaviorData }) {
 ...
 <p className="text-display-sm tracking-tight text-foreground/90">Work-Life Spending Hub</p>
 </div>
 </div>
 ...
 <div className="p-5 rounded-card-glass bg-secondary/40 border border-border/20 backdrop-blur-md flex items-center gap-4 group/insight">
 ...
 <p className="text-body-md tracking-tight text-foreground/80">50% Gaji habis dalam <span className="text-warning">{data.paydayDrainDays} Hari</span></p>
 </div>
 </div>
 ...
 <p className="text-label-md truncate text-foreground/80">{data.topWeekdayCategory}</p>
 </div>
 <div className="p-4 rounded-card-glass bg-muted/20 border border-border/10 space-y-2 hover:bg-muted/30 transition-all">
 <div className="flex items-center gap-2 text-muted-foreground/40">
 ...
 <p className="text-label-md truncate text-foreground/80">{data.topWeekendCategory}</p>
 </div>
 </div>
 </div>
 </div>
