                ...
                <div className="space-y-4">
                    <div className="flex justify-between items-end">
                        <div className="space-y-1">
                            <p className="text-[10px] font-bold uppercase tracking-widest text-zinc-400">Rata-rata Harian</p>
                ...
                <div className="space-y-4">
                    <div className="p-4 rounded-2xl bg-zinc-50 dark:bg-zinc-800/50 border border-zinc-100 dark:border-zinc-700/50 flex items-center gap-4">
                        ...
                        <div className="flex-1">
                            <p className="text-[10px] font-bold uppercase tracking-widest text-zinc-400">Payday Drain</p>
                            <p className="text-sm font-bold">50% Gaji Habis dalam <span className="text-orange-600">{data.paydayDrainDays} Hari</span></p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <div className="p-3 rounded-2xl border border-zinc-100 dark:border-zinc-800 space-y-2">
                            <div className="flex items-center gap-2 text-zinc-400">
                                ...
                                <span className="text-[9px] font-bold uppercase tracking-tighter">Top Weekday</span>
                            </div>
                            <p className="text-xs font-bold truncate">{data.topWeekdayCategory}</p>
                        </div>
                        <div className="p-3 rounded-2xl border border-zinc-100 dark:border-zinc-800 space-y-2">
                            <div className="flex items-center gap-2 text-zinc-400">
                                <Pizza className="h-3 w-3" />
                                <span className="text-[9px] font-bold uppercase tracking-tighter">Top Weekend</span>
                            </div>
                            <p className="text-xs font-bold truncate">{data.topWeekendCategory}</p>
                        </div>
                    </div>
                </div>
            </div>
