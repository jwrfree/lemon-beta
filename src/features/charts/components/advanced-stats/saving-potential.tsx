...
export function SavingPotential({ data }: { data: SavingPotentialData }) {
 ...
 <p className="text-display-sm tracking-tight text-foreground/90 leading-tight">Rencana Simpanan</p>
 </div>
 </div>
 ...
 <p className="text-display-lg tabular-nums text-success tracking-tighter">
 {formatCurrency(data.actualSavings)}
 </p>
 </div>
 <div className="space-y-1.5 text-right">
 <p className="text-label text-muted-foreground/40">Kapasitas maksimal</p>
 <p className="text-display-lg tabular-nums text-foreground/80 tracking-tighter">
 ...
 <span className="text-success ">{Math.round(efficiency)}%</span>
 </div>
 ...
 <p className="text-label-md text-foreground/80">Akselerator Aset</p>
