...
export function ExpenseHeatmap({ transactions, start, end }: ExpenseHeatmapProps) {
 ...
 <p className="text-body-md text-muted-foreground">Pola belanja harian Anda bulan ini</p>
 </div>
 </div>
 ...
 <div className="flex items-center gap-2 mt-4 text-label-md text-label text-muted-foreground/40">
 <span>Rendah</span>
