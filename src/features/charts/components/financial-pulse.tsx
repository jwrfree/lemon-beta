...
export function FinancialPulse({
 ...
 <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-success/10 rounded-full blur-[100px] -mr-48 -mt-48 animate-pulse [animation-duration:4000ms]"/>
 ...
 <h1 className="text-display-lg md:text-7xl tracking-tighter tabular-nums leading-none">
 {formatCurrency(net)}
 </h1>
 ...
 <span>Keuangan <b className="text-white font-black text-label-md ml-1">Surplus</b></span>
 ...
 <p className="text-display-sm md:text-display-md tabular-nums tracking-tighter">{formatCurrency(income)}</p>
 ...
 <span className="text-label-md text-white/40">Expenses</span>
 </div>
 <p className="text-display-sm md:text-display-md tabular-nums tracking-tighter">{formatCurrency(expense)}</p>
 <div className="w-full bg-white/10 h-1 mt-4 mb-3 rounded-full overflow-hidden">
 <motion.div 
 initial={{ width: 0 }}
