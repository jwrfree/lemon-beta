...
export function FinancialPulse({
    ...
    return (
        <div className="relative overflow-hidden rounded-card-premium bg-teal-950 text-white p-8 md:p-12 shadow-card mx-4 mt-4 border border-white/10">
            {/* Background Chart */}
            ...
            <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div className="p-5 rounded-card-glass bg-white/5 border border-white/10 backdrop-blur-sm shadow-card">
