...
export function ProphetChart({ transactions, historyStart, historyEnd, forecastDays = 30 }: ProphetChartProps) {
 ...
 return (
 <div className="w-full bg-white dark:bg-zinc-900 rounded-card-premium p-6 shadow-none border border-border/40 border border-zinc-100 dark:border-zinc-800 relative overflow-hidden">
 {/* Decorative AI Glow */}
 <div className="absolute -top-20 -right-20 w-40 h-40 bg-primary/20 blur-[80px] rounded-full pointer-events-none"/>

 <div className="flex items-center justify-between mb-6 relative z-10">
 <div>
 <h3 className="text-title-lg font-medium tracking-tight text-zinc-900 dark:text-zinc-100 flex items-center gap-2">
 <BrainCircuit className="w-5 h-5 text-purple-500"/>
 Prophet Engine (Beta)
 </h3>
 <p className="text-body-md text-zinc-500">Forecasting Cashflow 30 Hari ke Depan</p>
 </div>

 {finalPrediction && (
 <div className="text-right">
 <p className="text-label-md text-zinc-400">Proyeksi Akhir</p>
 <p className={cn("text-title-lg font-mono font-medium", isPositive ? "text-emerald-500": "text-rose-500")}>
 ...
 <div className="h-[350px] w-full text-label-md relative z-10">
 ...
 return (
 <div className="bg-white/90 dark:bg-zinc-950/90 backdrop-blur-md p-4 rounded-md shadow-xl border border-zinc-200 dark:border-zinc-800 text-body-md ring-1 ring-purple-500/20">
 <p className="font-medium mb-2 flex items-center justify-between">
 {format(parseISO(label), 'EEEE, d MMM')}
 {isPrediction && <span className="text-label-md bg-primary/10 text-primary px-1.5 py-0.5 rounded-full font-medium ">Forecast</span>}
 </p>
 ...
 <p className="text-label-md text-zinc-400 mb-1">Confidence Interval (95%)</p>
 <div className="flex justify-between gap-4 text-label-md font-mono text-zinc-500">
 ...
 <div className="flex items-start gap-2 mt-4 p-3 bg-primary/5 rounded-card text-label-md text-primary border border-primary/10">
