...
export function ProphetChart({ transactions, historyStart, historyEnd, forecastDays = 30 }: ProphetChartProps) {
 ...
 return (
 <div className="w-full bg-white dark:bg-zinc-900 rounded-card-premium p-6 shadow-none border border-border/15 border border-zinc-100 dark:border-zinc-800 relative overflow-hidden">
 {/* Decorative AI Glow */}
