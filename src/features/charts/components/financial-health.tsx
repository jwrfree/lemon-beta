...
export function HealthGauge({ savingsRate }: { savingsRate: number }) {
 ...
 return (
 <Card className="p-7 bg-card border-none rounded-card-glass shadow-none border border-border/15 flex flex-col justify-between h-full relative overflow-hidden group">
 ...
 <div className={cn("text-display-lg tracking-tighter tabular-nums mb-1", colorClass)}>
...
export function MetricCard({ title, value, subtitle, icon: Icon, trend }: {
 ...
 return (
 <Card className="group p-5 bg-card border-none rounded-card-glass shadow-none border border-border/15 hover:shadow-lg transition-all duration-300 relative overflow-hidden">
 ...
 <p className="text-display-md tracking-tighter tabular-nums mb-1 text-foreground">
 {value}
 </p>
