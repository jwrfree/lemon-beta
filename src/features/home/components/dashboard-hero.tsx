...
export const DashboardHero = ({
    ...
    return (
        <div className="grid gap-4 lg:grid-cols-3 items-stretch">
            <Card className="col-span-2 border border-white/10 shadow-none bg-primary text-primary-foreground overflow-hidden relative rounded-card">
            ...
            <Card className="border border-border/40 shadow-none bg-card rounded-card">
