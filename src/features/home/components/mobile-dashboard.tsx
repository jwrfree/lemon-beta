...
export const MobileDashboard = ({
 ...
 variant="ghost"
 size="icon"
 className="h-9 w-9 rounded-full bg-card text-muted-foreground hover:bg-muted hover:text-foreground shadow-none border-none"
 ...
 variant="ghost"
 size="icon"
 className="relative h-9 w-9 rounded-full bg-card text-muted-foreground hover:bg-muted hover:text-foreground shadow-none border-none"
 ...
 className="group relative flex h-36 w-48 flex-col items-center justify-center gap-3 overflow-hidden rounded-card-premium bg-card border border-dashed border-border transition-all hover:bg-muted/50 active:scale-95"
 >
