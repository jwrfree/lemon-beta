...
export const QuickAddWidget = () => {
 ...
 variant="ghost"
 size="sm"
 className="h-8 px-3 text-label-md text-label text-primary hover:bg-primary/5 rounded-full"
 ...
 <div className="flex items-center gap-2 text-label-md text-muted-foreground/60 bg-background/50 backdrop-blur-sm py-1.5 px-3 rounded-full w-fit border border-border/20">
