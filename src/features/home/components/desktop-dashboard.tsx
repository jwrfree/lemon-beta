...
export const DesktopDashboard = () => {
 ...
 const { setIsAIChatOpen, setIsWalletModalOpen } = useUI();
 ...
 <h1 className="text-body-lg tracking-tight text-foreground md:text-title-lg">
 Beranda
 </h1>
 </div>
 ...
 <h3 className="font-medium text-body-md">Allocation Radar</h3>
 </div>
 </div>
 <CategoryPie
