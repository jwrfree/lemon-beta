...
export const WalletCardStack = ({ wallets, activeIndex, setActiveIndex }: WalletCardStackProps) => {
 ...
 <p className="text-display-sm tracking-tight">{wallet.name}</p>
 ...
 <p className={cn("text-display-lg tracking-tighter tabular-nums", !isBalanceVisible && 'blur-md transition-all duration-500')}>
